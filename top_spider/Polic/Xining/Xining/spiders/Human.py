...
# http://rst.qinghai.gov.cn/pages/zxzx/tzgg/index2.html


class GovSpider(scrapy.Spider):
    name = 'Human'
    allowed_domains = ['xining.gov.cn']
    start_urls = ['http://rst.qinghai.gov.cn/pages/zxzx/tzgg/index.html']

    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="new_jobs_con"]//li/a/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="content_con"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        ...
        try:
            tables = html.xpath('//*[@class="content_con"]//table/@width')[0]
