...
#https://www.xining.gov.cn/xwdt/tzgg/index_1.html


class GovSpider(scrapy.Spider):
    name = 'Gov'
    allowed_domains = ['xining.gov.cn']
    start_urls = ['https://www.xining.gov.cn/xwdt/tzgg/index.html']

    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="clearfix"]/a/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@id="wenzhangzhengwen"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@id="wenzhangzhengwen"]')
        ...
        try:
            tables = html.xpath('//*[@id="wenzhangzhengwen"]//table/@width')[0]
