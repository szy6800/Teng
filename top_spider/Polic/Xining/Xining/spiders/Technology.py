...
#https://kjj.xining.gov.cn/sy/tzgg/index_1.html


class GovSpider(scrapy.Spider):
    name = 'Technology'
    allowed_domains = ['xining.gov.cn']
    start_urls = ['https://kjj.xining.gov.cn/sy/tzgg/index.html']

    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="gl-list"]/li/a/@href').getall()
        # 循环遍历
