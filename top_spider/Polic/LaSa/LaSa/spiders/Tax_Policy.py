...
class TaxPolicySpider(scrapy.Spider):
    name = 'Tax_Policy'
    allowed_domains = ['xizang.chinatax.gov.cn']

    # https://xizang.chinatax.gov.cn/module/web/jpage/dataproxy.jsp?startrecord=91&endrecord=135&perpage=15 # 政策解读 411  1 45

    def start_requests(self):
        # 构建url
        for l1, l2 in zip(range(1, 45, 45), range(46, 90, 45)):  # 411
