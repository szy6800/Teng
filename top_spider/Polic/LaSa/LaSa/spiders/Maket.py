...
#市场监督管理局
class MakeySpider(scrapy.Spider):
    name = 'Maket'
    allowed_domains = ['scjg.lasa.gov.cn']
    start_urls = ['http://scjg.lasa.gov.cn/scjgj/tggs/common_list.shtml',
                  'http://scjg.lasa.gov.cn/scjgj/zcjd/common_list.shtml']

    # http://scjg.lasa.gov.cn/scjgj/tggs/common_list.shtml #通知公告
    # http://scjg.lasa.gov.cn/scjgj/zcjd/common_list.shtml #政策解读
    # def start_requests(self):
    #     for p in range(1):
    #         p = f"_{p}" if p else ""
    #         url = f"http://scjg.lasa.gov.cn/scjgj/tggs/common_list{p}.shtml"
