...
class GovSpider(scrapy.Spider):
    ...
    start_urls = ['http://www.lasa.gov.cn/lasa/tggs/common_list.shtml',
                  'http://www.lasa.gov.cn/lasa/wjzl/common_list.shtml',
                  'http://www.lasa.gov.cn/lasa/zcjd/common_list.shtml']

    # http://www.lasa.gov.cn/lasa/tggs/common_list_25.shtml #通知公示 25
    # http://www.lasa.gov.cn/lasa/wjzl/common_list_14.shtml #政策文件 14
    # http://www.lasa.gov.cn/lasa/zcjd/common_list_14.shtml #政策解读 14

    # def start_requests(self):
    #     for p in range(14):
    #         p = f"_{p}" if p else ""
    #         url = f"http://www.lasa.gov.cn/lasa/zcjd/common_list{p}.shtml"
    #         yield scrapy.Request(url=url, callback=self.parse, dont_filter=True)

    def parse(self, response):
        item = {}

        list_url = response.xpath('//*[@class="contitle"]//a/@href').getall()
