...
class WjSpider(scrapy.Spider):
    ...
    start_urls = ['http://dghrss.dg.gov.cn/xwzx/gsgg/tzgg/index.html'] #20
    # start_urls = ['http://dghrss.dg.gov.cn/zcfg/index_{}.html'.format(i) for i in range(2,21)]
    #
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="list_div mar-top2 "]/div/a[1]/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        # 标题
        item['title'] = response.xpath("//*[@name='ArticleTitlte']/@content").get()
        # 城市id 360
        item['cityId'] = 360
