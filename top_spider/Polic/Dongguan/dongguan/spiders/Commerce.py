...
# http://dgboc.dg.gov.cn/gkmlpt/index#257

class WjSpider(scrapy.Spider):
    name = 'Commerce'
    allowed_domains = ['dg.gov.cn']
    start_urls = ['http://dgboc.dg.gov.cn/gkmlpt/api/all/257?page={}&sid=769028'.format(i) for i in range(1,2)]#80
    ...
    def parse_info(self, response):
        ...
        compal = re.compile('style=".*?"|https://im.dg.gov.cn/attachment/cmsfile/732158786/0201/201410/daofile/.*?gif|face=".*?"')
