...
class WjSpider(scrapy.Spider):
    ...
    # start_urls = ['https://jrj.dg.gov.cn/zwgk/tzgg/index_{}.html'.format(i) for i in range(1,8)]
    start_urls = ['https://jrj.dg.gov.cn/zwgk/tzgg/index.html']
