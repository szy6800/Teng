...
# http://dgamr.dg.gov.cn/gkmlpt/index#3261
class WjSpider(scrapy.Spider):
    name = 'Market'
    allowed_domains = ['dgamr.dg.gov.cn']
    start_urls = ['http://dgamr.dg.gov.cn/gkmlpt/api/all7/3246?page=1&sid=769027','http://dgamr.dg.gov.cn/gkmlpt/api/all/3261?page=1&sid=769027']
    # start_urls = ['http://dgamr.dg.gov.cn/gkmlpt/api/all/3261?page={}&sid=769027'.format(i) for i in range(10,22)] #22
    ...
    def parse_info(self, response):
        ...
        compal = re.compile(
            'style=".*?"|http://dgamr.dg.gov.cn/default/images/icon16/.*?gif|face=".*?"')
