...
# http://dghrss.dg.gov.cn/xwzx/gsgg/tzgg/index_2.html

class WjSpider(scrapy.Spider):
    name = 'Technology'
    allowed_domains = ['dg.gov.cn']
    start_urls = ['http://dgstb.dg.gov.cn/xxgk/zfxxgk/zfxxgkml/qt/tzgg/index.html']
    # start_urls = ['http://dgstb.dg.gov.cn/xxgk/zfxxgk/zfxxgkml/qt/tzgg/index_{}.html'.format(i) for i in range(2,21)]
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="padd lb"]/ul/li/a/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="zw"]//text()|//*[@id="zoomcon"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="zw"]|//*[@id="zoomcon"]')
        ...
        try:
            tables = html.xpath('//*[@class="zw"]//table/@width')[0]
