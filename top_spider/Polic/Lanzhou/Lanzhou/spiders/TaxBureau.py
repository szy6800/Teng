...
import htmlmin
# 税务局 http://gansu.chinatax.gov.cn/col/col70/index.html
...
class MarketSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        for l1, l2 in zip(range(1, 45, 45), range(45, 90, 45)):  # 650
            url = 'http://gansu.chinatax.gov.cn/module/web/jpage/dataproxy.jsp?startrecord={}&endrecord={}&perpage=15'.format(
                l1, l2)
            # 构建post请求参数
            data = {
                "col": "1",
