...
import htmlmin
#  教育局 http://jyj.lanzhou.gov.cn/col/col288/index.html
...
class MarketSpider(scrapy.Spider):
    ...
    def start_requests(self):
        # 构建url
        for l1, l2 in zip(range(1, 90, 90), range(90, 180, 90)):  # 450
            url = 'http://jyj.lanzhou.gov.cn/module/web/jpage/dataproxy.jsp?startrecord={}&endrecord={}&perpage=30'.format(
                l1, l2)
            # 构建post请求参数
            data = {
                "col": "1",
