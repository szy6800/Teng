...
import htmlmin
#  科学技术管理局 http://kjj.lanzhou.gov.cn/col/col3865/index.html


class MarketSpider(scrapy.Spider):
    name = 'Technology'
    allowed_domains = ['lanzhou.gov.cn']
    # start_urls = ['http://hebei.chinatax.gov.cn/sjzsw/gg/sjgg/index_{}.html'.format(i) for i in range(1,19)]
    ...
    def start_requests(self):
        # 构建url
        for l1, l2 in zip(range(1, 45, 30), range(30, 90, 30)):  # 450
            url = 'http://kjj.lanzhou.gov.cn/module/web/jpage/dataproxy.jsp?startrecord={}&endrecord={}&perpage=10'.format(
                l1, l2)
            # 构建post请求参数
            data = {
            "col" : "1",
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="neirong"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        ...
        try:
            tables = html.xpath('//*[@class="neirong"]//table/@width')[0]
