...
import htmlmin
# 市场监督管理局 http://scjgj.lanzhou.gov.cn/col/col10146/index.html
...
class MarketSpider(scrapy.Spider):
    ...
    def start_requests(self):
        # 构建url
        for l1, l2 in zip(range(1, 45, 45), range(45, 90, 45)):  # 450
            url = 'http://scjgj.lanzhou.gov.cn/module/web/jpage/dataproxy.jsp?startrecord={}&endrecord={}&perpage=15'.format(l1, l2)
            # 构建post请求参数
            data = {
                "col": "1",
                "appid": "1",
