...
# http://rsj.taiyuan.gov.cn/zfxxgk/gggs/index_2.shtml


class GovSpider(scrapy.Spider):
    name = 'Human'
    allowed_domains = ['taiyuan.gov.cn']
    start_urls = ['http://rsj.taiyuan.gov.cn/zfxxgk/gggs/index.shtml']

    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="List_list"]/li/a/@href').getall()
        # 循环遍历
