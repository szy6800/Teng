...
# http://scjgj.taiyuan.gov.cn/fzlm/gkmlpt/zdgk/index.shtml?chan=17315


class GovSpider(scrapy.Spider):
    name = 'Market'
    allowed_domains = ['taiyuan.gov.cn']
    start_urls = ['http://scjgj.taiyuan.gov.cn/intertidwebapp/govChanInfo/getDocuments?pageIndex={}&pageSize=20&siteId=94&ChannelType=1&KeyWord=&KeyWordType=&chanId=17313'.format(i) for i in range(1,2)]
