...
# http://www.taiyuan.gov.cn/zfxxgk/fdzdgknr/fgwj/gfxwj/index_2.shtml


class GovSpider(scrapy.Spider):
    name = 'Gov'
    allowed_domains = ['taiyuan.gov.cn']
    start_urls = ['http://www.taiyuan.gov.cn/zfxxgk/fdzdgknr/fgwj/gfxwj/index.shtml']

    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="pd20 clearfix"]/li/a/@href').getall()
        # 循环遍历
