...
class WjSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        for l1,l2 in zip(range(1,45,45),range(45,90,45)):
            url = 'https://sichuan.chinatax.gov.cn/module/web/jpage/dataproxy.jsp?startrecord={}&endrecord={}&perpage=15'.format(l1,l2)
            # 构建post请求参数
            data = {
                'col': '1',
                'webid': '1',
    ...
    def parse_info(self, response):
        ...
        compal = re.compile('style=".*?"|https://sichuan.chinatax.gov.cn/module/jslib/icons/.*?png')
