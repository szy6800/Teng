...
class WjSpider(scrapy.Spider):
    ...
    start_urls = ['http://cdjx.chengdu.gov.cn/es-search/search/e5b8fe1e6f3d4f768af14fb73c581180?_template=ucap/cdgy_zwxx&_isAgg=1&_pageSize=20&page={}'.format(i) for i in range(1,2)] #通知公告 #150
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="nctitle"]//a[1]/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@id="top"]//text()|//*[@class="main-show-txt"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@id="top"]|//*[@class="main-show-txt"]')
        ...
        compal = re.compile('style=".*?"|http://cdjx.chengdu.gov.cn/default/images/icon16/.*?gif|http://cdjx.chengdu.gov.cn/cdsjxw/uploadfiles/.*?gif')
        contentHtml = re.sub(compal, '', contentHtml)
        try:
            tables = html.xpath('//*[@id="top"]//table/@width|//*[@class="main-show-txt"]//table/@width')[0]
