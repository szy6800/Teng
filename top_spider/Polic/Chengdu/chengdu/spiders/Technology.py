...
class Wj4Spider(scrapy.Spider):
    ...
    start_urls = ['http://cdst.chengdu.gov.cn/cdkxjsj/c108728/part_list_more.shtml']

    def parse(self, response):
        item = {}
        # text = json.loads(response.text)
        list_url = response.xpath('//*[@class="ul"]//li//a/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        # 来源
        item['sourceSite'] = '成都市科学技术局'
        # 行业
        item['industry'] = response.urljoin('http://cdst.chengdu.gov.cn/cdkxjsj/c108728/part_list_more.shtml').replace('contant')
        # 行业id
        item['industryId'] = ''
        # 附件名
