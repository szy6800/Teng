...
# 成都市人力资源局 http://cdhrss.chengdu.gov.cn/cdrsj/c109728/list.shtml


class WjSpider(scrapy.Spider):
    name = 'Human'
    allowed_domains = ['chengdu.gov.cn']
    # start_urls = ['http://cdhrss.chengdu.gov.cn/cdrsj/c109728/list.shtml']
    # start_urls = ['http://cdhrss.chengdu.gov.cn/cdrsj/c109728/list_{}.shtml'.format(i) for i in range(1,6)]
    # start_urls = ['http://cdhrss.chengdu.gov.cn/es-search/search/e444eaeca74c4be6a186e84834d16a7b?_template=zhaofa/cdsrs_list&_isAgg=1&_pageSize=20&page={}'.format(i) for i in range(1,10)]
    start_urls = ['http://cdhrss.chengdu.gov.cn/es-search/search/102bf310355e471c9f5699f8e09754de?_template=zhaofa/cdsrs_list&_isAgg=1&_pageSize=20&page={}'.format(i) for i in range(1,2)] #通知公告
    #
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="clearfix list"]/li//a/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        try:
            tables = html.xpath('//*[@id="content"]//table/@width')[0]
