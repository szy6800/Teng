...
import htmlmin
#  http://neimenggu.chinatax.gov.cn/sjpd/hhht/tzgghhht/index_10.html


class GovSpider(scrapy.Spider):
    name = 'Tax'
    allowed_domains = ['chinatax.gov.cn']
    start_urls = ['http://neimenggu.chinatax.gov.cn/sjpd/hhht/tzgghhht/index.html']

    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="snewslist"]/li/a/@href').getall()
        #循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[contains(@class,"TRS_Ed")]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[contains(@class,"TRS_Ed")]')
        ...
        try:
            tables = html.xpath('//*[contains(@class,"TRS_Ed")]//table/@width')[0]
