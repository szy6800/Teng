...
import htmlmin
#  http://www.huhhot.gov.cn/zfxxgknew/fdzdgknr/?gk=3&cid=15493#iframe


class GovSpider(scrapy.Spider):
    name = 'Gov'
    allowed_domains = ['huhhot.gov.cn']
    start_urls = ['http://www.huhhot.gov.cn/zfxxgknew/fdzdgknr/zfwjnew/index.html']

    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="mobile"]/a/@href').getall()
        #循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[contains(@class,"view TR")]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[contains(@class,"view TR")]')
        ...
        try:
            tables = html.xpath('//*[contains(@class,"view TR")]//table/@width')[0]
