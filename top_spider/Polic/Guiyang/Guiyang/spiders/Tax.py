...
import htmlmin
# http://guizhou.chinatax.gov.cn/sjpd/gys/tzgg_59631/index.html


class GovSpider(scrapy.Spider):
    name = 'Tax'
    allowed_domains = ['guiyang.gov.cn']
    start_urls = ['http://guizhou.chinatax.gov.cn/sjpd/gys/tzgg_59631/index.html']
