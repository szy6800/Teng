...
import htmlmin
# http://rst.guizhou.gov.cn/zwgk/jdhy/zcwj/zcwj_5864662/index_1.html


class GovSpider(scrapy.Spider):
    name = 'Human'
    allowed_domains = ['guiyang.gov.cn']
    start_urls = ['http://rst.guizhou.gov.cn/zwgk/jdhy/zcwj/zcwj_5864662/index.html']


    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="right-list-box"]/ul/li/a/@href').getall()
        #循环遍历
