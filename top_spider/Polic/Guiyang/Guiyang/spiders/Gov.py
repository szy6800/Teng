...
import htmlmin
# http://www.guiyang.gov.cn/zwgk/zfxxgks/fdzdgknr/lzyj/gfxwj/szfgfxwj/zfh/index.html


class GovSpider(scrapy.Spider):
    name = 'Gov'
    allowed_domains = ['guiyang.gov.cn']
    start_urls = ['http://www.guiyang.gov.cn/zwgk/zfxxgks/fdzdgknr/lzyj/gfxwj/szfgfxwj/zfh/index.html']
