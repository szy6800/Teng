...
import htmlmin
# http://amr.guiyang.gov.cn/xwdt/tzgg/index_1.html


class GovSpider(scrapy.Spider):
    name = 'Market'
    allowed_domains = ['guiyang.gov.cn']
    start_urls = ['http://amr.guiyang.gov.cn/xwdt/tzgg/index.html']


    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="column_list"]/ul/li/a/@href').getall()
        # 去除最后一个
        #循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@id="article_content"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        ...
        try:
            tables = html.xpath('//*[@id="article_content"]//table/@width')[0]
