...
# http://xahrss.xa.gov.cn/xwzx/tzgg/list/64.html
class WjSpider(scrapy.Spider):
    name = 'Human'
    allowed_domains = ['xa.gov.cn']
    start_urls = ['http://xahrss.xa.gov.cn/xwzx/tzgg/{}.html'.format(i) for i in range(1,2)] #65
    # start_urls = ['http://xahrss.xa.gov.cn/xwzx/tzgg/list/{}.html'.format(i) for i in range(11,65)] #65
    #
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="m-lst"]/ul//a[1]/@href').getall()
        # 循环遍历
