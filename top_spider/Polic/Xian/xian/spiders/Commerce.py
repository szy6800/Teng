...
# http://xasswj.xa.gov.cn/xwzx/tzgg/1.html


class WjSpider(scrapy.Spider):
    name = 'Commerce'
    allowed_domains = ['xa.gov.cn']
    start_urls = ['http://xasswj.xa.gov.cn/xwzx/tzgg/{}.html'.format(i) for i in range(1,2)]  #24
    # start_urls = ['http://xasswj.xa.gov.cn/xwzx/tzgg/list/{}.html'.format(i) for i in range(11,24)]  #24
