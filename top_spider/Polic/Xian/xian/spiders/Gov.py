...
# http://xaczj.xa.gov.cn/xwzx/tzgg/list/14.html


class WjSpider(scrapy.Spider):
    name = 'Gov'
    allowed_domains = ['xa.gov.cn']
    # start_urls = ['http://xaczj.xa.gov.cn/xwzx/tzgg/list/{}.html'.format(i) for i in range(1,2)]  #16
    start_urls = ['http://www.xa.gov.cn/gk/zcfg/szf/list/{}.html'.format(i) for i in range(1, 2)]  #16
    ...
    #             p = f"_{p}" if p else ""
    #             url = f"http://rsj.wuhan.gov.cn/{cate}{p}.html"
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="table table-striped"]//tr//a/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@id="article"]//text()|//*[@class="article"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@id="article"]|//*[@class="article"]')
        ...
        try:
            tables = html.xpath('//*[@id="article"]//table/@width|//*[@class="article"]//table/@width')[0]
