...
class WjSpider(scrapy.Spider):
    ...
    start_urls = ['http://www.shenyang.gov.cn/syszf/zwgk/zcwj/zfwj/glist.html']
    # start_urls = ['http://www.shenyang.gov.cn/syszf/zwgk/zcwj/zfwj/glist{}.html'.format(i) for i in range(50,100)]
