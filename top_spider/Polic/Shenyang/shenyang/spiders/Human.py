...
class WjSpider(scrapy.Spider):
    ...
    start_urls = ['http://rsj.shenyang.gov.cn/syrsj/zwxx/zcfg/gwybwwj/glist.html','http://rsj.shenyang.gov.cn/syrsj/zwxx/zcjd/glist.html']
    ...
    def parse(self, response):
        ...
        list_url = response.xpath(
            '//*[@class="title"]/a[1]/@href| //*[@class="xxgk_rul"]//a[1]/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="text"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="text"]')
        ...
        try:
            tables = html.xpath('//*[@class="text"]//table/@width')[0]
