...
class WjSpider(scrapy.Spider):
    ...
    # start_urls = ['http://gdjr.gd.gov.cn/gdjr/zwgk/jrzcfg/index_{}.html'.format(i) for i in range(2,37)]
    start_urls = ['http://gdjr.gd.gov.cn/gdjr/zwgk/jrzcfg/index.html']
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="lista2a"]//li/a[1]/@href').getall()
        pub_dates = response.xpath('//*[@class="lista2b"]/ul/li/text()').getall()
        # print(pub_dates)
        # 循环遍历
