...
class WjSpider(scrapy.Spider):
    ...
    # start_urls = ['http://jyj.shenyang.gov.cn/syjyw/jyyw/glist.html']
    start_urls = ['http://jyj.shenyang.gov.cn/syjyw/jyyw/glist.html']
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="item"]/h3/a/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="WspContent14"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="WspContent14"]')
        ...
        try:
            tables = html.xpath('//*[@class="WspContent14"]//table/@width')[0]
