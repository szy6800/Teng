...
class WjSpider(scrapy.Spider):
    ...
    start_urls = ['http://jxw.shenyang.gov.cn/syjxw/tzgg/glist.html']
    # start_urls = ['http://jxw.shenyang.gov.cn/syjxw/tzgg/glist{}.html'.format(i) for i in range(1,43)]
    ...
    def parse_info(self, response):
        ...
        # 标题
        item['title'] = response.xpath("//*[@class='btk']/text()").get()
        # 城市id 1117
        item['cityId'] = 1117
        ...
        compal = re.compile('style=".*?"|http://jxw.shenyang.gov.cn/saas/plugins/ueditor/dialogs/attachment/fileTypeImages/icon_.*?gif|face=".*?"')
