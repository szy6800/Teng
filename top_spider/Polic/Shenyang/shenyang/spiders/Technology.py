...
class WjSpider(scrapy.Spider):
    ...
    start_urls = ['http://kjj.shenyang.gov.cn/kxjsj/zwgk/gfxwj/glist.html']
    # start_urls = ['http://kjj.shenyang.gov.cn/kxjsj/zwgk/gfxwj/glist1.html'.format(i) for i in range(1,12)]
    ...
    def parse(self, response):
        ...
        pub_dates = response.xpath('//*[@class="title"]/a/@href/following::div[@class="time_pub"]/text()').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="cent-center111"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="cent-center111"]')
        ...
        try:
            tables = html.xpath('//*[@class="cent-center111"]//table/@width')[0]
