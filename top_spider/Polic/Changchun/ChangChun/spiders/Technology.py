...
import htmlmin
# http://kjj.changchun.gov.cn/sy/tzgg/index.html


class GovSpider(scrapy.Spider):
    name = 'Technology'
    allowed_domains = ['changchun.gov.cn']
    start_urls = ['http://kjj.changchun.gov.cn/sy/tzgg/index.html']

    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="currency_ul"]/li/a/@href').getall()
    ...
    def parse_info(self, response):
        ...
        content = html.xpath("//*[contains(@class,'_Editor')]//text()|//*[@id='zoom']//text()")
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        ...
        #去 html标签
        div_data = html.xpath("//*[contains(@class,'_Editor')]|//*[@id='zoom']")
