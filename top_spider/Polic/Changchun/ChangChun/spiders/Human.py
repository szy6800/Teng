...
import htmlmin
# http://ccrs.changchun.gov.cn/ywdt/tzgg/index_2.html


class GovSpider(scrapy.Spider):
    name = 'Human'
    allowed_domains = ['changchun.gov.cn']
    start_urls = ['http://kjj.nanning.gov.cn/tzgg/tz/xmtz/index.html']

    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="x_zcjd_li mar0"]/li/a/@href').getall()
