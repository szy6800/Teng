...
class WjSpider(scrapy.Spider):
    name = 'Gov'
    allowed_domains = ['sh.gov.cn']
    # start_urls = ['https://www.shanghai.gov.cn/nw12344/index_{}.html'.format(i) for i in range(50,120)]#120
    start_urls = ['https://www.shanghai.gov.cn/nw12344/index.html']

    def parse(self, response):
        item = {}
        list_url = response.xpath("//*[@class='tadaty-list uli14 nowrapli list-date']//li/a[1]/@href").getall()
        pub_dates = response.xpath("//*[@class='tadaty-list uli14 nowrapli list-date']//li/a[1]/following::span[1]//text()").getall()
        # 循环遍历
