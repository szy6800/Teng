...
# 财政局 https://czj.sh.gov.cn/zss/zfxx/gsgg/index.html


class WjSpider(scrapy.Spider):
    name = 'Finance'
    allowed_domains = ['czj.sh.gov.cn']
    # start_urls = ['https://czj.sh.gov.cn/zss/zfxx/gsgg/index_{}.html'.format(i) for i in range(1,84)] #84
    start_urls = ['https://czj.sh.gov.cn/zss/zfxx/gsgg/index.html'] #84

    def parse(self, response):
        item = {}
        list_url = response.xpath('//*[@class="uli14 pageList"]//a[1]/@href').getall()
        pub_dates = response.xpath('//*[@class="uli14 pageList"]//a[1]/following::span[1]/text()').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        for elem in html.xpath('//style|//script|//*[@id="weibo_pos"]|//*[@class="acticle-link"]'):
