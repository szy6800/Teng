...
# 上海科学技术局 http://stcsm.sh.gov.cn/zwgk/zxgk/index_2.html

class WjSpider(scrapy.Spider):
    name = 'Technology'
    allowed_domains = ['czj.sh.gov.cn']
    # start_urls = ['http://stcsm.sh.gov.cn/zwgk/zxgk/index_{}.html'.format(i) for i in range(1,2)]  #
    start_urls = ['http://stcsm.sh.gov.cn/zwgk/zxgk/index.html']  #

    def parse(self, response):
        item = {}
        list_url = response.xpath('//*[@class="lis_bd common"]/li/a/@href').getall()
        # 循环遍历
