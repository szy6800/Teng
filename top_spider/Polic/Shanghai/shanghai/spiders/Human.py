...
class WjSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="uli14 nowrapli list-date no-margin-bottom"]/li//a/@href| //*[@class="table-container"]//a[1]/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="Article_content"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="Article_content"]')
        ...
        try:
            tables = html.xpath('//*[@class="Article_content"]//table/@width')[0]
