...
class WjSpider(scrapy.Spider):
    ...
    # start_urls = ['http://sheitc.sh.gov.cn/01050219/index_{}.html'.format(i) for i in range(1,28)]
    start_urls = ['http://sheitc.sh.gov.cn/01050219/index.html']
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="list clearfix"]//a[1]/@href').getall()
        # 循环遍历
