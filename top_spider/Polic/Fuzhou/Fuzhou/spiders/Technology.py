...
# http://www.fuzhou.gov.cn/zgfzzt/skjj/kjzl/tzgg_30057/index_1.htm
class TechnologySpider(scrapy.Spider):
    name = 'Technology'
    allowed_domains = ['fuzhou.gov.cn']
    start_urls = ['http://www.fuzhou.gov.cn/zgfzzt/skjj/kjzl/tzgg_30057/index_{}.htm'.format(i) for i in range(1,2)] #50
    ...
    def parse_info(self, response):
        ...
        try:
            tables = html.xpath('//*[@class="box1 font0"]//table/@width')[0]
