...
class GovSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.fuzhou.gov.cn/was5/web/search?channelid=290792&templet=advsch.jsp&sortfield=-docorderpri%2C-docreltime&classsql=(chnlid%3D5738)&random=0.5359746932754677&prepage=10&page={}'.format(i) for i in range(1,2)]#165
    # start_urls = ['http://www.fuzhou.gov.cn/was5/web/search?channelid=290792&templet=advsch.jsp&sortfield=-pubDate&classsql=parentid%3D2632%2C2587&random=0.36051038061073726&prepage=10&page={}'.format(i) for i in range(1,30)]#30
    ...
    def parse_info(self, response):
        ...
        # 标题
        item['title'] = response.xpath("//h4/text()").get()
        # 城市id 1794
        item['cityId'] = 1794
        ...
        content = html.xpath('//*[contains(@class,"Editor")]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[contains(@class,"Editor")]')
        ...
        try:
            tables = html.xpath('//*[contains(@class,"Editor")]//table/@width')[0]
