...
class TaxbureauSpider(scrapy.Spider):
    ...
    start_urls = ['http://fujian.chinatax.gov.cn/was5/web/search?channelid=203958&templet=advsch.jsp&sortfield=-docorderpri%2C-docreltime&classsql=%20chnlid%3D20190&prepage=15&page={}'.format(i) for i in range(1,2)] #9
