...
class MarketsupervisionbureauSpider(scrapy.Spider):
    ...
    start_urls = ['http://kjj.sjz.gov.cn/column.jsp?id=1533007476832&current={}'.format(i) for i in range(1,2)] #32
    ...
    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath("//*[contains(@href,'/col/1533007476832/20')]/@href").getall()
        # 循环遍历
