...
class MarketsupervisionbureauSpider(scrapy.Spider):
    ...
    start_urls = ['http://sjzjyj.sjz.gov.cn/dynamic/PageFront.jsp?parseId=745b8ad5a0b647b8859292efe60a4378&categoryId=a67a560e4cc8455999902184be54edb5&keyword=&pageNo={}&pageto='.format(i) for i in range(1,2)] #43
    ...
    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="sjxwcont"]//li//div/a[2]/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="content_fenye2"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        ...
        div_data = html.xpath('//*[@class="content_fenye2"]')
        ...
        try:
            tables = html.xpath('//*[@class="content_fenye2"]//table/@width')[0]
