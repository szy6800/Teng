...
class MarketsupervisionbureauSpider(scrapy.Spider):
    ...
    start_urls = ['http://hebei.chinatax.gov.cn/sjzsw/gg/xjgg/index_{}.html'.format(i) for i in range(1,6)]
    ...
    def parse(self, response):
        item = {}
        list_url = response.xpath('//*[@class="listalllef760"]/li/a/@href').getall()
        # 循环遍历
