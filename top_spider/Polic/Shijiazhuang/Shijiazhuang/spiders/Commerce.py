...
class MarketsupervisionbureauSpider(scrapy.Spider):
    ...
    start_urls = ['http://swj.sjz.gov.cn/column.jsp?id=1616572574239&current={}'.format(i) for i in range(1,2)] #7
    ...
    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="zwnrzw"]/div/div/a/@href').getall()
        # 循环遍历
