...
import htmlmin
# 科学技术局 http://kjj.km.gov.cn/tzgg/tz/index_10.shtml


class GovSpider(scrapy.Spider):
    name = 'Technology'
    allowed_domains = ['km.gov.cn']
    start_urls = ['http://kjj.km.gov.cn/tzgg/tz/index.shtml']
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="info"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        ...
        div_data = html.xpath('//*[@class="info"]')
        ...
        try:
            tables = html.xpath('//*[@class="info"]//table/@width')[0]
