...
import htmlmin
# 税务局 https://yunnan.chinatax.gov.cn/col/col7757/index.html?uid=16039&pageNum=1


class MarketSpider(scrapy.Spider):
    name = 'Tax'
    allowed_domains = ['yunnan.chinatax.gov.cn']
    ...
    def start_requests(self):
        ...
        for l1, l2 in zip(range(1, 45, 45), range(45, 90, 45)):  # 650
            url = 'https://yunnan.chinatax.gov.cn/module/web/jpage/dataproxy.jsp?startrecord={}&endrecord={}&perpage=15'.format(
                l1, l2)
            # 构建post请求参数
            data = {
                "col": "1",
                "webid": "1",
                "path": "http://yunnan.chinatax.gov.cn/",
                "columnid": "7757",
                "sourceContentType": "1",
                "unitid": "16039",
                "webname": "国家税务总局云南省税务局",
                "permissiontype": "0",
            }
            # 发送post请求
