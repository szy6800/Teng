...
import htmlmin
# 昆明市市场监督管理局 http://scjgj.km.gov.cn/zcms/catalog/31411/pc/index_45.shtml


class GovSpider(scrapy.Spider):
    name = 'Market'
    allowed_domains = ['km.gov.cn']
    start_urls = ['http://scjgj.km.gov.cn/zcms/catalog/31411/pc/index.shtml']

    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="w659"]/a/@href').getall()
        # 循环遍历
