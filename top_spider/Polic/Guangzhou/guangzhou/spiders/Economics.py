...
# 信息化局 http://gxj.gz.gov.cn/yw/tzgg/index.html
class WjSpider(scrapy.Spider):

    name = 'Economics'
    allowed_domains = ['gxj.gz.gov.cn']
    # start_urls = ['http://gxj.gz.gov.cn/yw/tzgg/index_{}.html'.format(i) for i in range(2,20)] #20
    start_urls = ['http://gxj.gz.gov.cn/yw/tzgg/index.html'] #20
    ...
    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath("//*[@class='News_list']/li/a/@href").getall()
        # 循环遍历
