...
class WjSpider(scrapy.Spider):
    name = 'Human'
    allowed_domains = ['rsj.gz.gov.cn']
    # start_urls = ['http://rsj.gz.gov.cn/gkmlpt/api/all/504?page={}&sid=200025'.format(i) for i in range(14,15)] #20
    start_urls = ['http://rsj.gz.gov.cn/gkmlpt/api/all/504?page={}&sid=200025'.format(i) for i in range(1,2)] #20
