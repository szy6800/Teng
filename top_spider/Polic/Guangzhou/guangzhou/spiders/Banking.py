...
class WjSpider(scrapy.Spider):
    ...
    # start_urls = ['http://jrjgj.gz.gov.cn/tzgg/index_{}.html'.format(i) for i in range(2,20)] #20
    start_urls = ['http://jrjgj.gz.gov.cn/tzgg/index.html'] #20

    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath("//*[@class='mainContent']/ul/li/a/@href").getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="info_cont"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="info_cont"]')
        ...
        try:
            tables = html.xpath('//*[@class="info_cont"]//table/@width')[0]
