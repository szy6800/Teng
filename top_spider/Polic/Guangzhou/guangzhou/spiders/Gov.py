...
class WjSpider(scrapy.Spider):
    ...
    # start_urls = ['http://www.gz.gov.cn/xw/tzgg/index_{}.html'.format(i) for i in range(2,100)] #100
    # start_urls = ['http://www.gz.gov.cn/xw/tzgg/index.html'] #100
    # start_urls = ['http://www.gz.gov.cn/zwgk/fggw/index_{}.html'.format(i) for i in range(2,100)] #19
    start_urls = ['http://www.gz.gov.cn/zwgk/fggw/index.html'] #19

    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath("//*[@class='news_list']//li/a/@href|//*[@class='wjbh_list']/li/a/@href").getall()
        # 循环遍历
