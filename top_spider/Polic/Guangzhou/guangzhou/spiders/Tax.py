...
class Wj1Spider(scrapy.Spider):
    ...
    def start_requests(self):
        for each in index():
            ...
            for p in range(pages):
                p = f"_{p + 1}" if p else ""
                url = f"https://guangdong.chinatax.gov.cn/{cate}{p}.shtml"
                yield scrapy.Request(url=url, callback=self.parse)

    def parse(self, response):
        item = {}
        list_url = response.xpath('//*[@class="pageList infoList listContent getChannel"]//li//a/@href|//*[@class="pageList infoList listContent"]//li//a/@href').getall()
        titles = response.xpath('//*[@class="pageList infoList listContent getChannel"]//li//a/@title|//*[@class="pageList infoList listContent"]//li//a/@title').getall()
        pub_dates = response.xpath('//*[@class="pageList infoList listContent getChannel"]//li//a/following::span[1]/text()|//*[@class="pageList infoList listContent"]//li//a/following::span[1]/text()').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@id="zoomcon"]//text()|//*[@class="content"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        ...
        div_data = html.xpath(
            '//*[@id="zoomcon"]|//*[@class="info_cont"]| //*[@class="article-content"]|//*[@class="article"]|//*[@class="content"]')
