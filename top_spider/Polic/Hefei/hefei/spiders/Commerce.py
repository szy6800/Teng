...
class WjSpider(scrapy.Spider):
    ...
    start_urls = ['http://swj.hefei.gov.cn/content/column/6793731?pageIndex={}'.format(i) for i in range(1,2)]#35
    ...
    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="doc_list list-6793731"]/li/a/@href').getall()
        # 循环遍历
