...
class WjSpider(scrapy.Spider):
    name = 'Market'
    allowed_domains = ['amr.ah.gov.cn']
    start_urls = ['http://amr.ah.gov.cn/content/column/31401412?SearchWords=&pageIndex={}'.format(i) for i in range(1,2)]
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="doc_list list-31401412"]//a/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="wzcon j-fontContent"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="wzcon j-fontContent"]')
        ...
        try:
            tables = html.xpath('//*[@class="wzcon j-fontContent"]//table/@width')[0]
