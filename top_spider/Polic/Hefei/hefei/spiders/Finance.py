...
class WjSpider(scrapy.Spider):
    ...
    start_urls = ['http://czj.hefei.gov.cn/content/column/6804291?pageIndex={}'.format(i) for i in range(1,2)]
    ...
    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="doc_list list-6804291"]/li/a/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="j-fontContent newscontnet minh500"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="j-fontContent newscontnet minh500"]')
        ...
        try:
            tables = html.xpath('//*[@class="j-fontContent newscontnet minh500"]//table/@width')[0]
