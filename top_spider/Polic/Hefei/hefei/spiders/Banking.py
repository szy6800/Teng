...
class WjSpider(scrapy.Spider):
    ...
    # start_urls = ['http://jrjgj.hefei.gov.cn/content/column/6790971?pageIndex={}'.format(i) for i in range(1,2)]#10
    ...
    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="doc_list list-6790971"]/li/a/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="wzcon min_h500 j-fontContent clearfix"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="wzcon min_h500 j-fontContent clearfix"]')
        ...
        try:
            tables = html.xpath('//*[@class="wzcon min_h500 j-fontContent clearfix"]//table/@width')[0]
