...
class WjSpider(scrapy.Spider):
    ...
    start_urls = ['http://jxj.hefei.gov.cn/content/column/6791841?pageIndex={}'.format(i) for i in range(1,2)]#26
    ...
    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="doc_list list-6791841"]/li/a/@href').getall()
        # 循环遍历
