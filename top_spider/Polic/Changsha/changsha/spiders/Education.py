...
class WjSpider(scrapy.Spider):
    ...
    # start_urls = ['http://jyj.changsha.gov.cn/zfxxgk/fdzdgk/lzyj/bmwj/index_{}.html'.format(i) for i in range(1,45)]
    start_urls = ['http://jyj.changsha.gov.cn/zfxxgk/fdzdgk/lzyj/bmwj/index.html','http://jyj.changsha.gov.cn/zfxxgk/fdzdgk/lzyj/jylgfxwj/index.html'] #30
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="xxgk-item"]/ul/li/a[1]/@href').getall()
        # print(list_url)
        # 循环遍历
