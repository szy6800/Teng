...
class WjSpider(scrapy.Spider):
    ...
    start_urls = ['http://dfjrjgj.hunan.gov.cn/dfjrjgj/xxgk_71626/tzgg/tz/index.html']  # 30

    # start_urls = ['http://dfjrjgj.hunan.gov.cn/dfjrjgj/xxgk_71626/tzgg/tz/index_{}.html'.format(i) for i in range(2,12)] #12
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="table"]//tr//td/a[1]/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="tys-main-zt-show"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="tys-main-zt-show"]')
        ...
        try:
            tables = html.xpath('//*[@class="tys-main-zt-show"]//table/@width')[0]
