...
class WjSpider(scrapy.Spider):
    ...
    start_urls = ['http://kjj.changsha.gov.cn/zfxxgk/tzgg_27202/'] #30
    # start_urls = ['http://kjj.changsha.gov.cn/zfxxgk/tzgg_27202/index_{}.html'.format(i) for i in range(60,100)] #30
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="list-box show"]/ul/li/a/@href').getall()
        # print(list_url)
        # 循环遍历
