...
class WjSpider(scrapy.Spider):
    ...
    # start_urls = ['http://swt.changsha.gov.cn/zfxxgk/tzgg_35733/index_{}.html'.format(i) for i in range(2,17)] #17
    start_urls = ['http://swt.changsha.gov.cn/zfxxgk/tzgg_35733/index.html'] #17
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="list list-date"]/ul/li/a[1]/@href').getall()
        # 循环遍历
