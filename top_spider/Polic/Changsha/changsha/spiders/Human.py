...
class WjSpider(scrapy.Spider):
    ...
    # start_urls = ['http://rsj.changsha.gov.cn/zxzx_0/tzgg_131288/rsrc_131289/index_2.html'] #30
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="bd_new bd_a80 right_list"]//li//a[1]/@href').getall()
        # 循环遍历
