...
class WjSpider(scrapy.Spider):
    ...
    start_urls = ['http://www.changsha.gov.cn/zfxxgk/zfwjk/srmzf/'] #30
    # start_urls = ['http://www.changsha.gov.cn/zfxxgk/zfwjk/srmzf/index_{}.html'.format(i) for i in range(1,31)] #30
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="wjk-list"]/li/p[2]/a[1]/@href').getall()
        # print(list_url)
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        for elem in html.xpath('//style|//script|//*[@id="div_div"]|//*[@class="print"]|//*[@id="Canvas"]|//*[@class="qrcode"]'):
            elem.getparent().remove(elem)
        content = html.xpath('//*[@class="content-main"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="content-main"]')
        ...
        try:
            tables = html.xpath('//*[@class="content-main"]//table/@width')[0]
