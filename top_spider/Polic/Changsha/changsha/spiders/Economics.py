...
class WjSpider(scrapy.Spider):
    ...
    # start_urls = ['http://csgy.changsha.gov.cn/XXGK/tzgg/index_{}.html'.format(i) for i in range(2,50)] #50
    start_urls = ['http://csgy.changsha.gov.cn/XXGK/tzgg/index.html'] #50
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="com_list com_list02"]/li//a[1]/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        for elem in html.xpath('//style|//script|//h2|//*[@class="note clearfix"]'):
            elem.getparent().remove(elem)
        content = html.xpath('//*[contains(@class,"TRS_UEDITOR")]//text()|//*[@class="content"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[contains(@class,"TRS_UEDITOR")]|//*[@class="content"]')
        ...
        try:
            tables = html.xpath('//*[contains(@class,"TRS_UEDITOR")]//table/@width')[0]
