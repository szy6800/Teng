...
import copy
from .Tax_text import type_polic,index

class WjSpider(scrapy.Spider):
    name = 'Tax'
    allowed_domains = ['hunan.chinatax.gov.cn']
    # start_urls = ['http://hunan.chinatax.gov.cn/cs/lists/20190719067982/1'] #通知公告
    ...
    def parse(self, response):
        item = {}
        # # 反序列化
        list_url = response.xpath('//*[@class="newsList"]/ul//li/a/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        compal = re.compile('style=".*?"|http://hunan.chinatax.gov.cn/ewebeditor/sysimage/icon16/.*?gif|face=".*?"')
