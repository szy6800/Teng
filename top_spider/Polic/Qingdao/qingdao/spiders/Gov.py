...
class WjSpider(scrapy.Spider):
    ...
    start_urls = ['http://www.qingdao.gov.cn/zwgk/zdgk/fgwj/zcjd/index.shtml']
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="list_box"]/ul[2]/li/a/@href').getall()
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@id="js_content"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        ...
        # print(item['content'])
        div_data = html.xpath('//*[@id="js_content"]')
        ...
        try:
            tables = html.xpath('//*[@id="js_content"]//table/@width')[0]
