...
class WjSpider(scrapy.Spider):
    ...
    # start_urls = ['http://jrb.qingdao.gov.cn/n26118648/n32560911/index_{}.html'.format(i) for i in range(2,30)]
    start_urls = ['http://jrb.qingdao.gov.cn/n26118648/n32560911/index.html']
    ...
    def parse_info(self, response):
        ...
        # 标题
        item['title'] = response.xpath("//h3//text()").get().strip()
        # 城市id
        item['cityId'] = 1211
        ...
        content = html.xpath('//*[@class="nrzhengwen"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="nrzhengwen"]')
        ...
        try:
            tables = html.xpath('//*[@class="nrzhengwen"]//table/@width')[0]
