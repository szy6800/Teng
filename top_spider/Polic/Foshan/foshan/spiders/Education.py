...
class WjSpider(scrapy.Spider):
    ...
    # start_urls = ['http://edu.foshan.gov.cn/zwgk/flfg/gfxwj/index.html','http://edu.foshan.gov.cn/zwgk/flfg/jyfl_new/index.html']
    start_urls = ['http://edu.foshan.gov.cn/zwgk/flfg/gfxwj/index.html']
    ...
    def parse(self, response):
        ...
        pub_dates = response.xpath('//*[@class="list"]/li/a/following::span[1]/text()').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="artcon"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        ...
        try:
            tables = html.xpath('//*[@class="artcon"]//table/@width')[0]
