...
# http://fsjrj.foshan.gov.cn/tzgg/index.html
class WjSpider(scrapy.Spider):
    name = 'Banking'
    allowed_domains = ['foshan.gov.cn']
    start_urls = ['http://fsjrj.foshan.gov.cn/tzgg/index.html']
    # start_urls = ['http://fsjrj.foshan.gov.cn/tzgg/index_{}.html'.format(i) for i in range(2,13)]
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="ny_wz_zi"]//li/a/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="wz_zi"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="wz_zi"]')
        ...
        try:
            tables = html.xpath('//*[@class="wz_zi"]//table/@width')[0]
        ...
        # 来源
        item['sourceSite'] = '佛山市人民政府金融工作局网站'
        # 行业
        item['industry'] = ''
        # 行业id
        item['industryId'] = ''
