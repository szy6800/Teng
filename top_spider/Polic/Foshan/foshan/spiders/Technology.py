...
class WjSpider(scrapy.Spider):
    ...
    start_urls = ['http://fskjj.foshan.gov.cn/2018/tzgg/index.html','http://fskjj.foshan.gov.cn/2018/zwgk/02/01/index.html','http://fskjj.foshan.gov.cn/2018/zwgk/02/02/index.html']
    # start_urls = ['http://fskjj.foshan.gov.cn/2018/tzgg/index_{}.html'.format(i) for i in range(2,21)]
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="list1"]/li/a/@href').getall()
        pub_dates = response.xpath('//*[@class="list1"]/li/a/following::span[1]/text()').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="arttxt"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="arttxt"]')
        ...
        try:
            tables = html.xpath('//*[@class="arttxt"]//table/@width')[0]
