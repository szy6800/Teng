...
# http://www.foshan.gov.cn/zwgk/zcwj/zcjd/bmjd/index_2.html
class WjSpider(scrapy.Spider):
    name = 'Gov'
    allowed_domains = ['foshan.gov.cn']
    start_urls = ['http://www.foshan.gov.cn/szfgfxwj/index.html?page=1']
    # start_urls = ['http://www.foshan.gov.cn/zwgk/zcwj/zcjd/bmjd/index_{}.html'.format(i) for i in range(2,21)]
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="listu"]/li/a/@href').getall()
        pub_dates = response.xpath('//*[@class="listu"]/li/a/following::span[1]/text()').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="m-con"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="m-con"]')
        ...
        try:
            tables = html.xpath('//*[@class="m-con"]//table/@width')[0]
