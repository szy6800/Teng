...
import hashlib
# http://hrss.foshan.gov.cn/zwgk/jcxxgk/zcfg/index.html

class WjSpider(scrapy.Spider):
    name = 'Human'
    allowed_domains = ['foshan.gov.cn']
    start_urls = ['http://hrss.foshan.gov.cn/zwgk/jcxxgk/zcfg/index.html']
    # start_urls = ['http://hrss.foshan.gov.cn/zwgk/jcxxgk/zcfg/index_{}.html'.format(i) for i in range(2,14)]
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="list_rightbox fr"]//li/a[1]/@href').getall()
        # 循环遍历
