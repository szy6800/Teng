...
# http://fsiit.foshan.gov.cn/zwgk/tz/index.html

class WjSpider(scrapy.Spider):
    name = 'Economics'
    allowed_domains = ['foshan.gov.cn']
    start_urls = ['http://fsiit.foshan.gov.cn/zwgk/tz/index.html']
    # start_urls = ['http://fsiit.foshan.gov.cn/zwgk/tz/index_{}.html'.format(i) for i in range(2,15)]
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@id="ARTICLES_"]//li/a[1]/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="poscon"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="poscon"]')
        ...
        try:
            tables = html.xpath('//*[@class="poscon"]//table/@width')[0]
