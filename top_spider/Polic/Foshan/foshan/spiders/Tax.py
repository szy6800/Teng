...
# https://guangdong.chinatax.gov.cn/gdsw/fssw_tzgg/city_list.shtml
class WjSpider(scrapy.Spider):
    name = 'Tax'

    allowed_domains = ['guangdong.chinatax.gov.cn']
    # start_urls = ['http://guangdong.chinatax.gov.cn/']
    ...
    def parse(self, response):
        item = {}
        list_url = response.xpath('//*[@class="pageList infoList listContent"]//li//a/@href|//*[@class="pageList infoList listContent getChannel"]//li//a/@href').getall()
        # print(response.text)
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        # 标题
        title = response.xpath("//*[@name='ArticleTitle']/@content").get().strip()
