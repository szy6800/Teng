...
# http://fscom.foshan.gov.cn/xwzx/tzgg/index_16.html

class WjSpider(scrapy.Spider):
    name = 'Commerce'
    allowed_domains = ['foshan.gov.cn']
    # start_urls = ['http://fscom.foshan.gov.cn/xwzx/tzgg/index_{}.html'.format(i) for i in range(2,21)]
    start_urls = ['http://fscom.foshan.gov.cn/xwzx/tzgg/index.html']
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="cont"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="cont"]')
        ...
        try:
            tables = html.xpath('//*[@class="cont"]//table/@width')[0]
