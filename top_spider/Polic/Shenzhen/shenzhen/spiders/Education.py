...
class WjSpider(scrapy.Spider):
    ...
    start_urls = ['http://szeb.sz.gov.cn/home/xxgk/flzy/gggs/index.html'] #40
    # start_urls = ['http://szeb.sz.gov.cn/home/xxgk/flzy/wjtz/index_39.html?page={}'.format(i) for i in range(1,2)] #40
    ...
    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath("//h1/a/@href").getall()
