...
class WjSpider(scrapy.Spider):
    name = 'Economics'
    allowed_domains = ['gxj.sz.gov.cn']
    #社会公示20
    start_urls = ['http://gxj.sz.gov.cn/xxgk/xxgkml/qt/tzgg/index.html']
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="ListconC"]//a[1]/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="TRS_Editor"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="TRS_Editor"]')
        ...
        try:
            tables = html.xpath('//*[@class="TRS_Editor"]//table/@width')[0]
