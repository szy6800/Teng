...
class WjSpider(scrapy.Spider):
    name = 'Banking'
    allowed_domains = ['jr.sz.gov.cn']
    #20
    start_urls = ['http://jr.sz.gov.cn/sjrb/xxgk/tzgg/index.html']
    # start_urls = ['http://jr.sz.gov.cn/sjrb/xxgk/tzgg/index.html']
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="AllListCon tabCont show"]//a[1]/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="TRS_Editor"]//text()|//*[@class="news_cont_d_wrap"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="TRS_Editor"]|//*[@class="news_cont_d_wrap"]')
        ...
        try:
            tables = html.xpath('//*[@class="TRS_Editor"]//table/@width|//*[@class="news_cont_d_wrap"]//table/@width')[0]
