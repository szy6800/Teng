...
class Wj1Spider(scrapy.Spider):
    name = 'Tax'
    allowed_domains = ['shenzhen.chinatax.gov.cn']
    ...
    def start_requests(self):
        for each in index():
            ...
            for p in range(pages):
                p = f"_{p + 1}" if p else ""
                url = f"https://shenzhen.chinatax.gov.cn/{cate}{p}.shtml"
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="articlecontent"]//text()|//*[@id="zoomcon"]//text()|//*[@class="content"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # bs4解析
        ...
        div_data = html.xpath(
            '//*[@class="articlecontent"]|//*[@id="zoomcon"]|//*[@class="content"]')
