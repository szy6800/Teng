...
class WjSpider(scrapy.Spider):
    name = 'Commerce'
    allowed_domains = ['commerce.sz.gov.cn']
    #20
    start_urls = ['http://commerce.sz.gov.cn/xxgk/qt/tzgg_1/index.html']
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="alist"]//a[1]/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="acontent"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="acontent"]')
        ...
        try:
            tables = html.xpath('//*[@class="acontent"]//table/@width')[0]
