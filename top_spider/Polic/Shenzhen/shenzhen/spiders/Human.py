...
class WjSpider(scrapy.Spider):
    name = 'Human'
    allowed_domains = ['hrss.sz.gov.cn']

    #社会公示20
    # start_urls = ['http://hrss.sz.gov.cn/xxgk/qtxx/shgs/index_{}.html'.format(i) for i in range(2,20)]
    # 通知公告20
    start_urls = ['http://hrss.sz.gov.cn/xxgk/qtxx/tzgg/index.html']
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="list_newbox"]//a[1]/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="news_cont_d_wrap"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="news_cont_d_wrap"]')
        ...
        try:
            tables = html.xpath('//*[@class="news_cont_d_wrap"]//table/@width')[0]
