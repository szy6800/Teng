...
class WjSpider(scrapy.Spider):
    ...
    # start_urls = ['http://stic.sz.gov.cn/xxgk/tzgg/index_{}.html'.format(i) for i in range(2,51)] #40
    # start_urls = ['http://stic.sz.gov.cn/xxgk/zcfg/zcjd/index.html'] #40
    start_urls = ['http://stic.sz.gov.cn/xxgk/zcfg/zcjd/index.html']
    ...
    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath("//*[@class='list-body']/div/p/a/@href").getall()
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="content"]//text()|//*[@class="article-content"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="content"]|//*[@class="article-content"]')
        ...
        try:
            tables = html.xpath('//*[@class="content"]//table/@width|//*[@class="article-content"]//table/@width')[0]
