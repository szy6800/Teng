...
class WjSpider(scrapy.Spider):
    ...
    start_urls = ['http://gxj.zhengzhou.gov.cn/tzgg/index.jhtml']
    # start_urls = ['http://gxj.zhengzhou.gov.cn/tzgg/index_{}.jhtml'.format(i) for i in range(2,77)]#77
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="list"]//a/@href').getall()
        # 循环遍历
