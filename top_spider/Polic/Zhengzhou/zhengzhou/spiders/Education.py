...
#  http://zzjy.zhengzhou.gov.cn/tzgg/index_2.jhtml
...
class WjSpider(scrapy.Spider):
    ...
    start_urls = ['http://zzjy.zhengzhou.gov.cn/tzgg/index.jhtml'] #34
    # start_urls = ['http://zzjy.zhengzhou.gov.cn/tzgg/index.jhtml'] #34
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="box-content"]//li/a/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="news_content_content"]//text()|//*[@class="content-txt"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="news_content_content"]|//*[@class="content-txt"]')
        ...
        try:
            tables = html.xpath('//*[@class="news_content_content"]//table/@width|//*[@class="content-txt"]//table/@width')[0]
