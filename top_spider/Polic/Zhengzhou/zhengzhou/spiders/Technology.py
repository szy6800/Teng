...
class WjSpider(scrapy.Spider):
    ...
    # start_urls = ['http://zzkj.zhengzhou.gov.cn/tzgg/index_{}.jhtml'.format(i) for i in range(80,161)] #161
    start_urls = ['http://zzkj.zhengzhou.gov.cn/tzgg/index.jhtml'] #161
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="news-list list-line"]/li//a[1]/@href').getall()
        # 循环遍历
