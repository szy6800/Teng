...
# http://zzrs.zhengzhou.gov.cn/tzgg/index.jhtml
class WjSpider(scrapy.Spider):
    name = 'Human'
    allowed_domains = ['zzrs.zhengzhou.gov.cn']
    # start_urls = ['http://zzrs.zhengzhou.gov.cn/tzgg/index.jhtml']
