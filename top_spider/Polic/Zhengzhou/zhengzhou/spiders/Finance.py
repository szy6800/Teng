...
class WjSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="listli"]/li//a[1]/@href').getall()
        # 循环遍历
