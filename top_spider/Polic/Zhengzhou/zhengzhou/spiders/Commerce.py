...
class WjSpider(scrapy.Spider):
    ...
    start_urls = ['http://swj.zhengzhou.gov.cn/tzgg/index.jhtml'] #60
    # start_urls = ['http://swj.zhengzhou.gov.cn/tzgg/index_{}.jhtml'.format(i) for i in range(2,60)] #60
