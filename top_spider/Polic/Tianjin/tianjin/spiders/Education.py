...
class WjSpider(scrapy.Spider):
    ...
    # start_urls = ['http://jy.tj.gov.cn/ZWGK_52172/zcwj/index.html']
    start_urls = ['http://jy.tj.gov.cn/ZWGK_52172/zcjd_1/']
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="common-list-right-list"]//a[1]/@onclick').getall()
        # 循环遍历
        for href in list_url:
            href = re.findall('http://jy.tj.gov.cn/.*?html', href)[0]
