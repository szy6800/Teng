...
class WjSpider(scrapy.Spider):
    name = 'Market'
    allowed_domains = ['scjg.tj.gov.cn']
    # start_urls = ['http://scjg.tj.gov.cn/']
    ...
    def start_requests(self):
        for each in index():
            ...
            for p in range(pages):
                p = f"_{p}" if p else ""
                url = f"http://scjg.tj.gov.cn/{cate}{p}.html"
    ...
    def parse(self, response):
        ...
        list_url = res.xpath('//*[@class="news_list"]/li/a/@href')
        titles = res.xpath('//*[@class="news_list"]/li/a/@title')
        pub_dates = res.xpath('//*[@class="news_list"]/li/a/following::span[1]//text()')
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="page_info"]//text()|//*[@class="article_content xl-zw-info"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        ...
        div_data = html.xpath('//*[@class="page_info"]|//*[@class="article_content xl-zw-info"]')
        ...
        compal = re.compile('style=".*?"|http://scjg.tj.gov.cn/govapp/lib/ueditor_demo/ueditor2/dialogs/attachment/fileTypeImages/.*?gif')
        contentHtml = re.sub(compal, '', contentHtml)
        try:
            tables = html.xpath('//*[@class="page_info"]//table/@width|//*[@class="article_content xl-zw-info"]//table/@width')[0]
