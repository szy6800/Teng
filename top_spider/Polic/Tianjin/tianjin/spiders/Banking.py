...
# http://jrgz.tj.gov.cn/xxfb/tzggl_1/
class WjSpider(scrapy.Spider):
    name = 'Banking'
    allowed_domains = ['tj.gov.cn']
    # start_urls = ['http://jrgz.tj.gov.cn/xxfb/tzggl_1/']
    start_urls = ['http://jrgz.tj.gov.cn/xxfb/tzggl_1/index.html']
    ...
    def parse(self, response):
        ...
        for href in list_url:
            href = re.findall('http://jrgz.tj.gov.cn/.*?html', href)[0]
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@id="zoom"]//text()|//*[@class="m-content-txt"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@id="zoom"]|//*[@class="m-content-txt"]')
