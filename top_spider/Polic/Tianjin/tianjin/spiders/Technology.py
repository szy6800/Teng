...
class WjSpider(scrapy.Spider):
    ...
    # start_urls = ['http://kxjs.tj.gov.cn/ZWGK4143/TZGG2079/index_{}.html'.format(i) for i in range(2,25)]
    start_urls = ['http://kxjs.tj.gov.cn/ZWGK4143/ZCFG148_1/ZCJD20201127/index.html']
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="news_list news_list2"]/li/a/@href').getall()
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="page_info"]//text()|//*[@class="m-content-txt"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="page_info"]|//*[@class="m-content-txt"]')
