...
class WjSpider(scrapy.Spider):
    ...
    # start_urls = ['http://www.tj.gov.cn/zwgk/szfwj/tjsrmzf/index_10960_{}.html'.format(i) for i in range(2,68)]
    start_urls = ['http://www.tj.gov.cn/zwgk/szfwj/tjsrmzf/index_10960.html']
    # start_urls = ['http://www.tj.gov.cn/zwgk/zcjd/index_{}.html'.format(i) for i in range(2,49)]
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="list-circle-red"]//a[1]/@onclick').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@id="xlrllt"]//text()|//*[@id="zoom"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@id="xlrllt"]|//*[@id="zoom"]')
        ...
        try:
            tables = html.xpath('//*[@id="xlrllt"]//table/@width|//*[@id="zoom"]//table/@width')[0]
