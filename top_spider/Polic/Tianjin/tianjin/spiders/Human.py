...
# http://hrss.tj.gov.cn/zhengwugongkai/zhengcezhinan/zcfgnew1/jycjnew/index_1.html

class WjSpider(scrapy.Spider):
    name = 'Human'
    allowed_domains = ['tj.gov.cn']
    start_urls = ['http://hrss.tj.gov.cn/zhengwugongkai/zhengcezhinan/zcfgnew1/flfgnew/'.format(i) for i in range(1,2)]
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="fmultimedia-y fl"]//ul//a[1]/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@id="xlrllt"]//text()|//*[@class="article"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@id="xlrllt"]|//*[@class="article"]')
        ...
        try:
            tables = html.xpath('//*[@id="xlrllt"]//table/@width|//*[@class="article"]//table/@width')[0]
