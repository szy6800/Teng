...
# http://cz.tj.gov.cn/zwgk_53713/zcwjx/
class WjSpider(scrapy.Spider):
    name = 'Finance'
    allowed_domains = ['tj.gov.cn']
    start_urls = ['http://cz.tj.gov.cn/igs/front/search/list.html?index=tjsczj_1&type=czjzcwj_1&orderProperty=PUBDATE&orderDirection=desc&filter[DOCTITLE-like]=&filter[PUBDATE-gte]=&filter[PUBDATE-lte]=&filter[MN-like]=&filter[ND-like]=&pageNumber={}&filter[AVAILABLE]=true'.format(i) for i in range(1,2)]
    ...
    def parse(self, response):
        ...
        # list_url = response.xpath('//*[@class="content-right-list overflow"]//a[1]/@onclick').getall()
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@id="xlrllt"]//text()|//*[@class="m-content-txt"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@id="xlrllt"]|//*[@class="m-content-txt"]')
        ...
        try:
            tables = html.xpath('//*[@id="xlrllt"]//table/@width')[0]
