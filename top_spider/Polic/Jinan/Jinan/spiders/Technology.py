...
import htmlmin
 ...
 # 科学技术局 http://jnsti.jinan.gov.cn/col/col13061/index.html
...
class TaxbureauSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        for l1, l2 in zip(range(1, 45, 45), range(45, 90, 45)):#650
            url = 'http://jnsti.jinan.gov.cn/module/web/jpage/dataproxy.jsp?startrecord={}&endrecord={}&perpage=15'.format(
                l1, l2)
            # 构建post请求参数
            data = {
                "col": "1",
                "webid": "10",
                "path": "http://jnsti.jinan.gov.cn/",
                "columnid": "13061",
                "sourceContentType": "1",
                "unitid": "14541",
                "webname": "%E6%B5%8E%E5%8D%97%E5%B8%82%E7%A7%91%E5%AD%A6%E6%8A%80%E6%9C%AF%E5%B1%80",
                "permissiontype": "0",
            }
            # 发送post请求
