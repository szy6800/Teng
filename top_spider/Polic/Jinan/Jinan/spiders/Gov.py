...
import htmlmin
# http://www.jinan.gov.cn/col/col44545/index.html?uid=543824&pageNum=20
...
class GovSpider(scrapy.Spider):
    ...
    def start_requests(self):
        # 构建url
        for l1, l2 in zip(range(1, 60, 60), range(60, 120, 60)):# 1500
            # for l1, l2 in zip(range(1, 400, 30), range(400, 1100, 30)):
            url = 'http://www.jinan.gov.cn/module/web/jpage/dataproxy.jsp?startrecord={}&endrecord={}&perpage=20'.format(
                l1, l2)
            # 构建post请求参数
            data = {
                'col': '1',
