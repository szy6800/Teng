...
import htmlmin
 ...
 # 教育局 http://jnsti.jinan.gov.cn/col/col13061/index.html
...
class TaxbureauSpider(scrapy.Spider):
    ...
    def start_requests(self):
        # 构建url
        for l1, l2 in zip(range(1, 45, 45), range(45, 90, 45)):#1000
            url = 'http://jnedu.jinan.gov.cn/module/web/jpage/dataproxy.jsp?startrecord={}&endrecord={}&perpage=15'.format(
                l1, l2)
            # 构建post请求参数
            data = {
                "col": "1",
                "webid": "9",
                "path": "http://jnedu.jinan.gov.cn/",
                "columnid": "18904",
                "sourceContentType": "1",
                "unitid": "45544",
                "webname": "%E6%B5%8E%E5%8D%97%E5%B8%82%E6%95%99%E8%82%B2%E5%B1%80",
                "permissiontype": "0",
            }
            # 发送post请求
