...
#http://www.urumqi.gov.cn/info/iList.jsp?cat_id=15784


class GovSpider(scrapy.Spider):
    name = 'Technology'
    allowed_domains = ['urumqi.gov.cn']
    start_urls = ['http://www.urumqi.gov.cn/info/iList.jsp?cat_id=15784&cur_page={}'.format(i) for i in range(1,2)]
