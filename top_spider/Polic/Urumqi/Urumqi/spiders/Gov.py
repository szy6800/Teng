...
#http://www.urumqi.gov.cn/info/iList.jsp?cat_id=12115
class GovSpider(scrapy.Spider):
    name = 'Gov'
    allowed_domains = ['urumqi.gov.cn']
    start_urls = ['http://www.urumqi.gov.cn/info/iList.jsp?cat_id=10006&cur_page={}'.format(i) for i in range(1,2)]
