...
#http://www.urumqi.gov.cn/info/iList.jsp?cat_id=15393&cur_page=3

class GovSpider(scrapy.Spider):
    name = 'Market'
    allowed_domains = ['urumqi.gov.cn']
    start_urls = ['http://www.urumqi.gov.cn/info/iList.jsp?cat_id=15393&cur_page={}'.format(i) for i in range(1,2)]
