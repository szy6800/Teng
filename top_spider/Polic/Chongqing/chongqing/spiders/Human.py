...
class WjSpider(scrapy.Spider):
    ...
    # start_urls = ['http://rlsbj.cq.gov.cn/zwgk_182/fdzdgknr/lzyj/xzgfxwj_1/xzgfxwj/index_{}.html'.format(i) for i in range(1,39)] #39
    start_urls = ['http://rlsbj.cq.gov.cn/zwgk_182/fdzdgknr/lzyj/xzgfxwj_1/xzgfxwj/index.html'] #39
