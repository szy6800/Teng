...
class WjSpider(scrapy.Spider):
    ...
    start_urls = ['http://jw.cq.gov.cn/zwgk_209/fdzdgknr/zcwj/xzgfxwj/index.html']
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="public-r-c-name"]//a/@href').getall()
        # 循环遍历
