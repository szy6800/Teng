...
# 重庆市 http://kjj.cq.gov.cn/zwgk_176/fdzdgknr/zcwj/xzgfxwj/index_2.html
class WjSpider(scrapy.Spider):
    name = 'Technology'
    allowed_domains = ['cq.gov.cn']
    start_urls = ['http://kjj.cq.gov.cn/zwgk_176/fdzdgknr/zcwj/xzgfxwj/index.html']
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="zsj-fr-main"]/li/a/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        for elem in html.xpath('//style|//script|//*[@id="div_div"]|//*[@class="print"]|//*[@id="Canvas"]|//*[@class="bdsharebuttonbox bdshare-button-style1-24"]'):
            elem.getparent().remove(elem)
        content = html.xpath('//*[@class="zwxl-article pages_content"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="zwxl-article pages_content"]')
        ...
        try:
            tables = html.xpath('//*[@class="zwxl-article pages_content"]//table/@width')[0]
