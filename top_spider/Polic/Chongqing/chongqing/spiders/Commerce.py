...
#http://sww.cq.gov.cn/zwgk_247/zfxxgkml/tzgg/list.html
class WjSpider(scrapy.Spider):
    name = 'Commerce'
    allowed_domains = ['cq.gov.cn']
    start_urls = ['http://sww.cq.gov.cn/zwgk_247/zfxxgkml/tzgg/list.html']
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="hdjl-table"]//a[1]/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        compal = re.compile('style=".*?"|http://sww.cq.gov.cn/govapp/lib/ueditor_demo/ueditor2/dialogs/attachment/fileTypeImages/icon_.*?gif|face=".*?"')
