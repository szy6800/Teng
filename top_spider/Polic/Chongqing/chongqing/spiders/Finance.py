...
# 重庆市财政局 http://czj.cq.gov.cn/zwgk_268/gsgg/ywgg/index_1.html
class WjSpider(scrapy.Spider):
    name = 'Finance'
    allowed_domains = ['cq.gov.cn']
    start_urls = ['http://czj.cq.gov.cn/zwgk_268/gsgg/ywgg/index.html']
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="list"]//a[1]/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        # 标题
        item['title'] = response.xpath("//p[@class='tit']/text()").get()
        # 城市id 1549
        item['cityId'] = 8
        ...
        try:
            pub_date = response.xpath("//span[@class='con']/text()").get()
