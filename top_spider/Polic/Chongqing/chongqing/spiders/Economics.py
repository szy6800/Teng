...
# 经济和信息化委员会 https://jjxxw.cq.gov.cn/zwgk_213/zcwj/qtwj/index_2.html
class WjSpider(scrapy.Spider):
    name = 'Economics'
    allowed_domains = ['cq.gov.cn']
    start_urls = ['https://jjxxw.cq.gov.cn/zwgk_213/zcwj/qtwj/index.html'] #35
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="right-list"]/li/a/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        compal = re.compile('style=".*?"|https://jjxxw.cq.gov.cn/govapp/lib/ueditor_demo/ueditor2/dialogs/attachment/fileTypeImages/icon_.*?gif|face=".*?"')
