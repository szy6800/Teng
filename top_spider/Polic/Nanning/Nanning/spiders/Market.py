...
# 市场监督管理局 http://scjgj.nanning.gov.cn/xxgk/tzgg_6596/index_39.html


class GovSpider(scrapy.Spider):
    name = 'Market'
    allowed_domains = ['nanning.gov.cn']
    start_urls = ['http://scjgj.nanning.gov.cn/xxgk/tzgg_6596/index.html']

    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="has_line"]/li/a/@href').getall()
        # 循环遍历
