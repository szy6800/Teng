...
# 税务局 http://guangxi.chinatax.gov.cn/nanning/tzgg/sjtzgg/index_13.html


class GovSpider(scrapy.Spider):
    name = 'Tax'
    allowed_domains = ['guangxi.chinatax.gov']
    start_urls = ['http://guangxi.chinatax.gov.cn/nanning/tzgg/sjtzgg/index.html']

    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="lmy_info"]/ul/li/a/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="pc"]//*[@class="article-body"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        ...
        div_data = html.xpath('//*[@class="pc"]//*[@class="article-body"]')
        ...
        try:
            tables = html.xpath('//*[@class="pc"]//*[@class="article-body"]//table/@width')[0]
