...
class WjSpider(scrapy.Spider):
    ...
    start_urls = ['http://www.wuhan.gov.cn/zwgk/zwgk_wl/zc/']
    ...
    def parse(self, response):
        ...
        list_url = re.findall('http://www.wuhan.gov.cn/.*?shtml',response.text)
        print(len(list_url))
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        for elem in html.xpath('//style|//script|//*[@class="shareWrapper clear"]|//*[@class="textbody-bottom no-print"]'):
            elem.getparent().remove(elem)
        content = html.xpath('//*[@class="article no_border"]//text()|//*[@class="article"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="article no_border"]|//*[@class="article"]')
        ...
        try:
            tables = html.xpath('//*[@class="article no_border"]//table/@width')[0]
