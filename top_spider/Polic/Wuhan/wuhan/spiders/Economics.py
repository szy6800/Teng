...
# http://jxj.wuhan.gov.cn/zxzj/zxzj_xmgg/index_4.html
class WjSpider(scrapy.Spider):
    name = 'Economics'
    allowed_domains = ['wuhan.gov.cn']
    # start_urls = ['http://jxj.wuhan.gov.cn/xwzx_9/tztg/index_1.html']
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="art_item"]/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="art_content"]//text()|//*[@class="article"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="art_content"]|//*[@class="article"]')
        ...
        try:
            tables = html.xpath('//*[@class="art_content"]//table/@width|//*[@class="article"]//table/@width')[0]
