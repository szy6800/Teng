...
class WjSpider(scrapy.Spider):
    ...
    start_urls = ['http://kjj.wuhan.gov.cn/wmfw/tzgg/tzgg_18371/index.html']
    # start_urls = ['http://kjj.wuhan.gov.cn/wmfw/tzgg/tzgg_18371/index_{}.html'.format(i) for i in range(2,18)]
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="list_news clearfix"]/ul/li/a/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="art_content clearfix"]//text()|//*[@class="article"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="art_content clearfix"]|//*[@class="article"]')
        ...
        try:
            tables = html.xpath('//*[@class="art_content clearfix"]//table/@width')[0]
