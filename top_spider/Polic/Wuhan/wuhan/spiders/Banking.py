...
# http://jrj.wuhan.gov.cn/ynzx_57/tzgg/index_1.shtml
class WjSpider(scrapy.Spider):
    name = 'Banking'
    allowed_domains = ['wuhan.gov.cn']
    start_urls = ['http://jrj.wuhan.gov.cn/ynzx_57/tzgg/index.shtml']
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="item-box min1020"]/li/a/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@id="article-box"]//text()|//*[@class="article"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@id="article-box"]|//*[@class="article"]')
        ...
        try:
            tables = html.xpath('//*[@id="article-box"]//table/@width')[0]
