...
# http://rsj.wuhan.gov.cn/zwgk_17/zc/qtzdgkwj/zcfg/index_1.html
class WjSpider(scrapy.Spider):
    name = 'Human'
    allowed_domains = ['wuhan.gov.cn']
    # start_urls = ['http://rsj.wuhan.gov.cn/zwgk_17/zc/qtzdgkwj/zcfg/index_49.html'.format(i) for i in range(1,50)]
    ...
    def parse(self, response):
        ...
        list_url = response.xpath('//*[@class="rrContainer"]/ul//a[1]/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        for elem in html.xpath('//style|//script|//*[@class="table table-bordered"]'):
            elem.getparent().remove(elem)
        content = html.xpath('//*[@id="contentDiv"]//text()|//*[@class="article"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@id="contentDiv"]|//*[@class="article"]')
        ...
        try:
            tables = html.xpath('//*[@id="contentDiv"]//table/@width|//*[@class="article"]//table/@width')[0]
