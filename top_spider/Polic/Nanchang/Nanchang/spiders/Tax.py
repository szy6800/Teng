...
import htmlmin
 ...
 # 税务局 http://jiangxi.chinatax.gov.cn/col/col31079/index.html
...
class TaxbureauSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        for l1, l2 in zip(range(1, 45, 45), range(45, 90, 45)):
            url = 'http://jiangxi.chinatax.gov.cn/module/web/jpage/dataproxy.jsp?startrecord={}&endrecord={}&perpage=15'.format(
                l1, l2)
            # 构建post请求参数
            data = {
                "col": "1",
                "webid": "26",
                "path": "http://jiangxi.chinatax.gov.cn/",
                "columnid": "31079",
                "sourceContentType": "1",
                "unitid": "56535",
                "webname": "国家税务总局江西省税务局",
                "permissiontype": "0",
            }
            # 发送post请求
