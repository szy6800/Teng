...
import htmlmin
#  http://kjj.nc.gov.cn/nckjj/tztg/nav_list.shtml


class GovSpider(scrapy.Spider):
    name = 'Technology'
    allowed_domains = ['nc.gov.cn']
    start_urls = ['http://kjj.nc.gov.cn/nckjj/tztg/nav_list_{}.shtml'.format(i) for i in range(1,50)]

    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="cont mt10"]/ul/li/a/@href').getall()
