...
import htmlmin
#http://www.nc.gov.cn/ncszf/qtygwj/zfxxgk_list.shtml


class GovSpider(scrapy.Spider):
    name = 'Gov'
    allowed_domains = ['nc.gov.cn']
    start_urls = ['http://www.nc.gov.cn/ncszf/qtygwj/zfxxgk_list.shtml'] #21

    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="pageList newsList"]/li/a/@href').getall()
