...
class WjSpider(scrapy.Spider):
    name = 'Human'
    allowed_domains = ['hrss.suzhou.gov.cn']
    # start_urls = ['http://hrss.suzhou.gov.cn/jsszhrss/gsgg/list.shtml']
    ...
    def parse(self, response):
        ...
        list_url = response.xpath("//*[@class='list_newbox']//a[1]/@href | //*[@class='con_box']//td/a/@href").getall()
        # 循环遍历
