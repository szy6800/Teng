...
class Wj4Spider(scrapy.Spider):
    ...
    # start_urls = ['http://kjj.suzhou.gov.cn/szkj/tzgg/common_list_{}.shtml'.format(i) for i in range(2,100)]
    start_urls = ['http://kjj.suzhou.gov.cn/szkj/tzgg/common_list.shtml']
    ...
    def parse(self, response):
        ...
        list_url = response.xpath("//*[@class='pageList infoList listContent']//a/@href").getall()
        # 循环遍历
