...
class Wj4Spider(scrapy.Spider):
    ...
    # start_urls = ['http://jyj.suzhou.gov.cn/szjyj/gsgg/list_{}.shtml'.format(i) for i in range(2,35)]
    start_urls = ['http://jyj.suzhou.gov.cn/szjyj/gsgg/list.shtml']
