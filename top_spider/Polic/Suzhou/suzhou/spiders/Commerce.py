...
class Wj2Spider(scrapy.Spider):
    name = 'Commerce'
    allowed_domains = ['commerce.suzhou.gov.cn']
    start_urls = ['http://commerce.suzhou.gov.cn/szsswj/tzgg/list.shtml']
    # start_urls = ['http://commerce.suzhou.gov.cn/szsswj/tzgg/list_{}.shtml'.format(i) for i in range(2,27)]
    ...
    def parse(self, response):
        ...
        list_url = response.xpath("//*[@class='qglh']/@href").getall()
        # 循环遍历
