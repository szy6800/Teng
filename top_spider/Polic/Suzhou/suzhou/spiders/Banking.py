...
class Wj4Spider(scrapy.Spider):
    name = 'Banking'
    allowed_domains = ['jrjgj.suzhou.gov.cn']
    start_urls = ['http://jrjgj.suzhou.gov.cn/szdfjr/tzgg/list.shtml']
    # start_urls = ['http://jrjgj.suzhou.gov.cn/szdfjr/tzgg/list_{}.shtml'.format(i) for i in range(2,4)]
    ...
    def parse(self, response):
        ...
        list_url = response.xpath("//ul[@class='item lh jt_dott f14']/li//a/@href").getall()
        # 循环遍历
