...
#  杭州市经济和信息化局 http://jxj.hangzhou.gov.cn/col/col1692658/index.html?number=A007A001
class WjSpider(scrapy.Spider):
    name = 'Economics'
    allowed_domains = ['hangzhou.gov.cn']
    start_urls = ['http://jxj.hangzhou.gov.cn/module/xxgk/search.jsp?standardXxgk=0&isAllList=1&texttype=0&fbtime=-1&vc_all=&vc_filenumber=&vc_title=&vc_number=&currpage={}&sortfield=b_settop:0,createdatetime:0,orderid:0&infotypeId=0&jdid=3244&area=%20&divid=div1692658&vc_title=&vc_number=&sortfield=b_settop:0,createdatetime:0,orderid:0&currpage=2&vc_filenumber=&vc_all=&texttype=0&fbtime=-1&standardXxgk=0&isAllList=1&texttype=0&fbtime=-1&vc_all=&vc_filenumber=&vc_title=&vc_number=&currpage=2&sortfield=b_settop:0,createdatetime:0,orderid:0'.format(i) for i in range(1,2)] #200
    ...
    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="tab_box"]//a[1]/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="articlect"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="articlect"]')
        ...
        try:
            tables = html.xpath('//*[@class="articlect"]//table/@width')[0]
