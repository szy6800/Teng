...
#  杭州市金融监管局 http://jxj.hangzhou.gov.cn/col/col1692658/index.html?number=A007A001
class WjSpider(scrapy.Spider):
    name = 'Banking'
    allowed_domains = ['hangzhou.gov.cn']
    start_urls = ['http://www.hangzhou.gov.cn/module/xxgk/search.jsp?standardXxgk=0&isAllList=1&texttype=&fbtime=&vc_all=&vc_filenumber=&vc_title=&vc_number=&currpage={}&sortfield=,createdatetime:0,orderid:0&infotypeId=F01000020101&jdid=149&area=&divid=div1510978&vc_title=&vc_number=&sortfield=,createdatetime:0,orderid:0&currpage=3&vc_filenumber=&vc_all=&texttype=&fbtime=&standardXxgk=0&isAllList=1&texttype=&fbtime=&vc_all=&vc_filenumber=&vc_title=&vc_number=&currpage=3&sortfield=,createdatetime:0,orderid:0'.format(i) for i in range(1,2)] #33
    ...
    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//td//a[1]/@href').getall()
        # 循环遍历
