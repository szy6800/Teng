...
#  杭州市财政局 http://jxj.hangzhou.gov.cn/col/col1692658/index.html?number=A007A001
class WjSpider(scrapy.Spider):
    ...
    def start_requests(self):
        # 构建url
        for l1, l2 in zip(range(1, 33, 33), range(34, 66, 33)):
            url = 'http://czj.hangzhou.gov.cn/module/jpage/dataproxy.jsp?startrecord={}&endrecord={}&perpage=11'.format(
                l1, l2)
            # 构建post请求参数
            data = {
                'col': '1',
