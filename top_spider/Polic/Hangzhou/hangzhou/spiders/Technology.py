...
class WjSpider(scrapy.Spider):
    ...
    def start_requests(self):
        # 构建url
        # for l1, l2 in zip(range(1, 1400, 45), range(45, 1400, 45)):#1400
        for l1, l2 in zip(range(1, 45, 45), range(45, 90, 45)):#1400
            url = 'http://kj.hangzhou.gov.cn/module/jpage/dataproxy.jsp?startrecord={}&endrecord={}&perpage=15'.format(l1, l2)
            # 构建post请求参数
            data = {
                    "col": "1",
                    "appid": "1",
