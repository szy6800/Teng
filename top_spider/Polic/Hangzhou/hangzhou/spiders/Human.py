...
#  杭州市人力资源和社会保障局 http://hrss.hangzhou.gov.cn/col/col1229196644/index.html


class WjSpider(scrapy.Spider):
    name = 'Human'
    allowed_domains = ['hangzhou.gov.cn']
    start_urls = ['http://hrss.hangzhou.gov.cn/module/xxgk/search.jsp?standardXxgk=0&isAllList=1&texttype=&fbtime=&vc_all=&vc_filenumber=&vc_title=&vc_number=&currpage={}&sortfield=,compaltedate:0&infotypeId=HZRS030303&jdid=3163&area=&divid=div1229196644&vc_title=&vc_number=&sortfield=,compaltedate:0&currpage=2&vc_filenumber=&vc_all=&texttype=&fbtime=&standardXxgk=0&isAllList=1&texttype=&fbtime=&vc_all=&vc_filenumber=&vc_title=&vc_number=&currpage=2&sortfield=,compaltedate:0'.format(i) for i in range(1,2)] #90
    ...
    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="tsjp_nr"]//td//a[1]/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="newscontent newscontent_w"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="newscontent newscontent_w"]')
        ...
        compal = re.compile('style=".*?"|http://hrss.hangzhou.gov.cn/module/jslib/icons/.*?png|face=".*?"')
        contentHtml = re.sub(compal, '', contentHtml)
        try:
            tables = html.xpath('//*[@class="newscontent newscontent_w"]//table/@width')[0]
