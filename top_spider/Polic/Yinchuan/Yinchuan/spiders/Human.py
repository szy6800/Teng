...
# http://rsj.yinchuan.gov.cn/xxgk/zdgk/tzgg/index_16.htm


class GovSpider(scrapy.Spider):
    name = 'Human'
    allowed_domains = ['yinchuan.gov.cn']
    start_urls = ['http://rsj.yinchuan.gov.cn/xxgk/zdgk/tzgg/index_{}.htm'.format(i) for i in range(1,19)]
