...
# http://kjj.yinchuan.gov.cn/tzgg_7774/index_1.html


class GovSpider(scrapy.Spider):
    name = 'Technology'
    allowed_domains = ['yinchuan.gov.cn']
    start_urls = ['http://kjj.yinchuan.gov.cn/tzgg_7774/index_{}.html'.format(i) for i in range(1,3)]
