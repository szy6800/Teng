...
# http://www.yinchuan.gov.cn/xxgk/zcwj/qtzfwj/swbwj/index_1.html


class GovSpider(scrapy.Spider):
    name = 'Gov'
    allowed_domains = ['yinchuan.gov.cn']
    start_urls = ['http://www.yinchuan.gov.cn/xxgk/zcwj/qtzfwj/swbwj/index_{}.html'.format(i) for i in range(1,60)]


    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="tab"]//tr//a[1]/@href').getall()
        # 循环遍历
    ...
    def parse_info(self, response):
        ...
        content = html.xpath('//*[@class="text-con"]//text()')
        sss = ''
        for i in content:
            sss = sss + i
        # 去除
        item['content'] = sss.strip()
        div_data = html.xpath('//*[@class="text-con"]')
        ...
        try:
            tables = html.xpath('//*[@class="text-con"]//table/@width')[0]
