...
# http://scjg.yinchuan.gov.cn/zxdt/tzgg/index_1.html


class GovSpider(scrapy.Spider):
    name = 'Market'
    allowed_domains = ['yinchuan.gov.cn']
    start_urls = ['http://scjg.yinchuan.gov.cn/zxdt/tzgg/index_{}.html'.format(i) for i in range(1,12)]


    def parse(self, response):
        # print(response.text)
        item = {}
        list_url = response.xpath('//*[@class="list2"]/li/a/@href').getall()
        # 循环遍历
