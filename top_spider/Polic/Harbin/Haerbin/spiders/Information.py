...
class InformationSpider(scrapy.Spider):
    ...
    start_urls = ['http://xxgk.harbin.gov.cn/module/xxgk/search.jsp?texttype=&fbtime=&vc_all=&vc_filenumber=&vc_title=&vc_number=&currpage={}&sortfield=createdatetime:0,orderid:0&fields=&fieldConfigId=&hasNoPages=&infoCount=?infotypeId=&jdid=2&area=002276764&divid=div11562&vc_title=&vc_number=&sortfield=createdatetime:0,orderid:0&currpage=2&vc_filenumber=&vc_all=&texttype=&fbtime=&texttype=&fbtime=&vc_all=&vc_filenumber=&vc_title=&vc_number=&currpage=2&sortfield=createdatetime:0,orderid:0&fields=&fieldConfigId=&hasNoPages=&infoCount='.format(i) for i in range(1,2)]#20
