...
class HumanSpider(scrapy.Spider):
    ...
    start_urls = ['http://xxgk.harbin.gov.cn/module/xxgk/search.jsp?texttype=&fbtime=&vc_all=&vc_filenumber=&vc_title=&vc_number=&currpage={}&sortfield=createdatetime:0,orderid:0&fields=&fieldConfigId=&hasNoPages=&infoCount=?infotypeId=&jdid=2&area=002277003&divid=div11570&vc_title=&vc_number=&sortfield=createdatetime:0,orderid:0&currpage=3&vc_filenumber=&vc_all=&texttype=&fbtime=&texttype=&fbtime=&vc_all=&vc_filenumber=&vc_title=&vc_number=&currpage=3&sortfield=createdatetime:0,orderid:0&fields=&fieldConfigId=&hasNoPages=&infoCount='.format(i) for i in range(1,2)]#46
    ...
    def parse_info(self, response):
        ...
        # 来源
        item['sourceSite'] = '哈尔滨市人力资源和社会保障局'
        # 行业
        item['industry'] = ''
        # 行业id
        item['industryId'] = ''
