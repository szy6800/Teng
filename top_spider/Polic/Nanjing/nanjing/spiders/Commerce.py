...
# http://swj.nanjing.gov.cn/njsswj/214/228/index_17523.html

class Wj2Spider(scrapy.Spider):
    name = 'Commerce'
    allowed_domains = ['swj.nanjing.gov.cn']
    start_urls = ['http://swj.nanjing.gov.cn/igs/front/search/publish/data/list.html?&index=wzqsearch-v20190124&type=infomation&siteId=75&pageSize=20&orderProperty=DOCRELTIME&pageIndex=3&orderDirection=desc&filter%5BSITEID%5D=75&filter%5BCHANNELID%5D=&filter%5BGROUPCAT%5D=228&pageNumber={}'.format(i) for i in range(1,2)]
