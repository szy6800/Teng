...
class Wj1Spider(scrapy.Spider):
    name = 'Economics'
    allowed_domains = ['jxw.nanjing.gov.cn']
    start_urls = ['http://jxw.nanjing.gov.cn/igs/front/search/publish/data/list.html?&index=wzqsearch-v20190124&type=infomation&siteId=50&pageSize=20&orderProperty=DOCRELTIME&pageIndex=3&orderDirection=desc&filter%5BSITEID%5D=50&filter%5BCHANNELID%5D=&filter%5BGROUPCAT%5D=228&pageNumber={}'.format(i) for i in range(1,2)]
