...
# http://www.njkj.gov.cn/njskxjswyh/?id=xxgk_228
class Wj4Spider(scrapy.Spider):
    name = 'Technology'
    allowed_domains = ['njkl.gov.cn']
    start_urls = ['http://www.njkj.gov.cn/igs/front/search/publish/data/list.html?&index=wzqsearch-v20190124&type=infomation&siteId=52&pageSize=20&orderProperty=DOCRELTIME&pageIndex=2&orderDirection=desc&filter%5BSITEID%5D=52&filter%5BCHANNELID%5D=&filter%5BGROUPCAT%5D=228&pageNumber={}'.format(i) for i in range(1,2)]
