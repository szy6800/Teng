...
#http://www.njcz.gov.cn/njsczj/214/228/index_17408.html#chnlid=23956
class Wj4Spider(scrapy.Spider):
    name = 'Finance'
    allowed_domains = ['njcz.gov.cn']
    start_urls = ['http://www.njcz.gov.cn/igs/front/search/publish/data/list.html?&index=wzqsearch-v20190124&type=infomation&siteId=56&pageSize=20&orderProperty=DOCRELTIME&pageIndex=1&orderDirection=desc&filter%5BSITEID%5D=56&filter%5BCHANNELID%5D=23956&filter%5BGROUPCAT%5D=228&pageNumber={}'.format(i) for i in range(1,2)]
