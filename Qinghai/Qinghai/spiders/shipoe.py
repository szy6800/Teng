...
# @Author : 石张毅
# @Site :http://www.shipoe.com 船海装备网
# @introduce:
...
class ShipoeSpider(scrapy.Spider):
    name = 'shipoe'
    allowed_domains = ['shipoe.com']
    start_urls = ['http://shipoe.com/']

    def __init__(self, *args, **kwargs ):
        super(ShipoeSpider, self).__init__()
        self.cates = [
            {"cate": "", "pages": 5},  # 招标公告
        ]
        self.t = Times()
    ...
    def start_requests(self):
        for each in self.cates:
            ...
            for p in range(1 ,pages):
                # p = f"_{p+1}" if p else ""
                url = f"https://www.shipoe.com/news/list-939-{p}.html"
    ...
    def parse(self, response):
        ...
        # print(titles)
        pub_times = response.xpath('//*[@class="catlist"]/ul/li/a/preceding::i[1]/text()').getall()
        #循环遍历
