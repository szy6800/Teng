...
class HuanbaoSpider(scrapy.Spider):
    name = 'huanbao'
    allowed_domains = ['huanbao.bjx.com.cn']
    start_urls = ['http://huanbao.bjx.com.cn/']

    def __init__(self, *args, **kwargs ):
        super(HuanbaoSpider, self).__init__()
        self.cates = [
            {"cate": "", "pages": 3},  # 招标公告
    ...
    def start_requests(self):
        for each in self.cates:
            ...
            for p in range(1, pages):
                url = f"https://huanbao.bjx.com.cn/zb/{p}/"
