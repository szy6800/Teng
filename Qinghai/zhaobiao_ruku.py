...
def df_to_mysql(df):
    df.to_sql(name = 'zhaobiao2021_copy1',
            # con = 'mysql+pymysql://root:@127.0.0.1:3306/test?charset=utf8',
            con = 'mysql+pymysql://root:Lxp.138927!asd@123.126.87.123:3306/crawler2022?charset=utf8',
...
def dbz():
    ...
    # otherStyleTime = '2022-05-23'
    # sql = f'''SELECT uid,uuid,title,link,intro,abs,content,publish_time,purchaser,proxy,create_time,update_time,deleted,province,base,type,items,data_source,end_time,status,serial FROM `zhaobiao2021` WHERE create_time='{otherStyleTime}' AND data_source!='00108' AND abs!='3 'order by id  limit 10;'''
    sql = f'''SELECT uid,uuid,title,link,intro,abs,content,publish_time,purchaser,proxy,create_time,update_time,deleted,province,base,type,items,data_source,end_time,status,serial FROM `zhaobiao2021` order by id  limit 1,10;'''
    ...
    engine2 = create_engine('mysql+pymysql://root:Lxp.138927!asd@123.126.87.123:3306/crawler2022?charset=utf8')
...
if __name__ == "__main__":
    ...
    # scheduler.add_job(job, 'cron', hour=23, minute=37)
    # try:
    #     scheduler.start()
