...
class QhfloorPipeline:
    def __init__(self, pool):
        ...
        self.insert_sql = """
             INSERT INTO qh_house_floor(
                             check_md5,uid,url,buildno,unit,elevator,floors,sets,area,housetypename,salesstatus
                         )VALUES ('{}','{}', '{}', '{}', '{}', '{}', '{}', '{}','{}','{}','{}')
         """
        # self.query_sql = """SELECT * FROM xian_village_quchong WHERE url_md5='{}'"""
        self.query_sql = """SELECT * FROM qh_house_floor WHERE uid='{}'"""
        # 更改语句,插入语句"
        #self.update_sql3 = """UPDATE qh_house SET lng='{}',lat='{}',developers='{}',disrictname='{}',units='{}',housecnt='{}',availablecnt='{}',unavailablecnt='{}',soldcnt='{}',salesname='{}' WHERE check_md5='{}';"""
