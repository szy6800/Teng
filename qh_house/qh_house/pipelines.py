    ...
    def __init__(self, pool):
        ...
        self.insert_sql = """
             INSERT INTO qh_house(
                             check_md5,url,name,house_type,area_range,nsale_time,address,features,price,lastmodifydate,detail_id
                         )VALUES ('{}','{}', '{}', '{}', '{}', '{}', '{}', '{}','{}','{}','{}')
         """
        # self.query_sql = """SELECT * FROM xian_village_quchong WHERE url_md5='{}'"""
        self.query_sql = """SELECT * FROM qh_house WHERE check_md5='{}'"""
        # 更改语句,插入语句
        self.update_sql3 = """UPDATE qh_house SET detail_id='{}' WHERE check_md5='{}';"""
