...
def queryue(sql):
    ...
    # engine = create_engine('mysql+mysqlconnector://root:Lxp.138927!asd@123.126.87.123:3306/crawler2022?charset=utf8')
...
def id_sult():
    ...
    sql = f"SELECT uid,uuid,title,link,intro,abs,content,publish_time,purchaser,proxy,create_time,update_time,deleted,province,base,type,items,data_source,end_time,status,serial FROM `zhaobiao2021_copy1`"
